...
model_urls = {
    'wmt-lstm' : './model/wmtlstm-b142a7f2.pth'
}
...
class MTLSTM(nn.Module):
    ...
    def __init__(self, n_vocab=None, vectors=None, residual_embeddings=False):
        ...
        self.rnn.load_state_dict(torch.load(model_urls['wmt-lstm']))

        self.residual_embeddings = residual_embeddings

    def forward(self, inputs, inputs_mask, hidden=None):
        ...
        """
        lengths = inputs_mask.data.eq(0).long().sum(1).squeeze()
